...
echo $_SESSION['userID'] ;
	...
	if ($stmt = $mysqli->prepare ( $query )) {
		$stmt->bind_param ( "ii", $_GET ['textID'], $_SESSION ['userID'] );
		$stmt->execute ();
...
<?php include_once 'includes/main_nav.php'; ?>
    ...
    <div class="flipper">
        ...
        <div class="back">
			...
			<?php echo $define[$noteCardIndex]; ?>
        </div>
		
    </div>
</div>
 <div class="large-12 columns">
                                    <a value= --$a class="button small">Previous Word</a>
									 <a value= ++$a class="button small">Next Word</a>
